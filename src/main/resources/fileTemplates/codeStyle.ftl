...
<SYM_MESSAGE>welcome</SYM_MESSAGE> = Welcome, {
<SYM_VARIABLE>$user</SYM_VARIABLE> }!
<SYM_MESSAGE>time-elapsed</SYM_MESSAGE> = Time elapsed: {
<SYM_FUNCTION>NUMBER</SYM_FUNCTION>(
<SYM_VARIABLE>$duration</SYM_VARIABLE>,
<SYM_VARIABLE>maximumFractionDigits</SYM_VARIABLE>: 0) }s.
<SYM_TERM>-brand-name</SYM_TERM> = Firefox
<SYM_MESSAGE>installing</SYM_MESSAGE> = Installing {
<SYM_TERM>-brand-name</SYM_TERM> }.

# Selectors
<SYM_MESSAGE>your-score</SYM_MESSAGE> = You scored {
<SYM_FUNCTION>NUMBER</SYM_FUNCTION>(
<SYM_VARIABLE>$score</SYM_VARIABLE>,
<SYM_VARIABLE>minimumFractionDigits</SYM_VARIABLE>: 1) ->
[0.0]   zero points. What happened?
*[
<SYM_TERM>other</SYM_TERM>] {
<SYM_FUNCTION>NUMBER</SYM_FUNCTION>(
<SYM_VARIABLE>$score</SYM_VARIABLE>,
<SYM_VARIABLE>minimumFractionDigits</SYM_VARIABLE>: 1)} points.
}
