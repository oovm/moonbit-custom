...
public class MoonParser implements PsiParser, LightPsiParser {
    ...
    /* ********************************************************** */
    // modifier* KW_IMPLEMENT identifier-free KW_FOR identifier-free return-type?
    ...
    // return-type?
    private static boolean declare_impl_5(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_impl_5")) return false;
        return_type(b, l + 1);
        return true;
    }
    ...
    public static boolean term_expression_atom(PsiBuilder b, int l) {
        ...
        if (!r) r = term_expression_atom_7(b, l + 1);
    ...
    // AT namepath-free
    private static boolean term_expression_atom_7(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "term_expression_atom_7")) return false;
        boolean r;
        Marker m = enter_section_(b);
        r = consumeToken(b, AT);
