...
public class MoonParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // identifier? SINGLE_QUOTE_L STRING_TEXT+ SINGLE_QUOTE_R
  public static boolean char_literal(PsiBuilder b, int l) {
      ...
      r = r && consumeToken(b, SINGLE_QUOTE_L);
      r = r && char_literal_2(b, l + 1);
    ...
    // STRING_TEXT+
    private static boolean char_literal_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "char_literal_2")) return false;
        boolean r;
        Marker m = enter_section_(b);
        ...
        while (r) {
            ...
            if (!empty_element_parsed_guard_(b, "char_literal_2", c)) break;
        }
        exit_section_(b, m, null, r);
        return r;
    }
    ...
    /* ********************************************************** */
    // modifier* function-extern? KW_FN namepath declare-generic? declare-parameters return-type? (function-body | function-inline) {
    // //	pin = 3
    ...
    /* ********************************************************** */
    // modifier* KW_TYPE OP_ERROR? type-expression type-expression?
    ...
    /* ********************************************************** */
    // (KW_IF|KW_GUARD) then-statement else-statement?
    public static boolean if_statement(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "if_statement")) return false;
        if (!nextTokenIs(b, "<if statement>", KW_GUARD, KW_IF)) return false;
        boolean r, p;
