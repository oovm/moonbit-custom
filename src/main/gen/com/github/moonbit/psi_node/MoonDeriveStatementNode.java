...
import com.github.moonbit.psi.MoonDeriveStatement;
...
public class MoonDeriveStatementNode extends AnyMoonNode implements MoonDeriveStatement {

    public MoonDeriveStatementNode(@NotNull ASTNode node) {
        super(node);
    }
