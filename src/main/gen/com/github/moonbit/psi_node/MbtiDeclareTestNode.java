...
import com.github.moonbit.psi.MbtiDeclareTest;
import com.github.moonbit.psi.MbtiFunctionBody;
import com.github.moonbit.psi.MbtiStringLiteral;
...
public class MbtiDeclareTestNode extends AnyMbtiNode implements MbtiDeclareTest {

    public MbtiDeclareTestNode(ASTNode node) {
        super(node);
    }
