...
import com.github.moonbit.psi.MbtiControlBreak;
...
public class MbtiControlBreakNode extends AnyMbtiNode implements MbtiControlBreak {

    public MbtiControlBreakNode(ASTNode node) {
        super(node);
    }
