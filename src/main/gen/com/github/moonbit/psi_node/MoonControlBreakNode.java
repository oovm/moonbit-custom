...
import com.github.moonbit.psi.MoonControlBreak;
...
public class MoonControlBreakNode extends AnyMoonNode implements MoonControlBreak {

    public MoonControlBreakNode(@NotNull ASTNode node) {
        super(node);
    }
